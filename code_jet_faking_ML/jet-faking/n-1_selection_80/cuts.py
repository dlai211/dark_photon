...
# ---------- SELECTION CUT ------------
    ...
    mask2 = metsig_tmp < 16
    fb = fb[mask1 * mask2]
    log_step(ntuple_name, step, "16>met_tst_sig>7", fb, start_time); step += 1
    ...
    log_step(ntuple_name, step, "dphi_met_phterm>1.34", fb, start_time); step += 1

    dmet_tmp = fb['met_tst_noJVT_et'] - fb['met_tst_et']
    mask1 = dmet_tmp > -17900
    # fb = fb[mask1]
    # log_step(ntuple_name, step, "dmet>-17.9GeV", fb, start_time); step += 1
    mask2 = dmet_tmp < 41900
    fb = fb[mask1 * mask2]
    log_step(ntuple_name, step, "41.9GeV>dmet>-17.9GeV", fb, start_time); step += 1
    ...
    log_step(ntuple_name, step, "dphi_jj_central<2.58", fb, start_time); step += 1
...
shared_cuts = [
    ...
    'dmet>-17.9GeV',
    'dphi_jj_central<2.58',
    'dphi_met_jetterm<0.73'
]
...
shared_cuts = [
    ...
    '16>met_tst_sig>7',
    'ph_eta<1.74',
    'dphi_met_phterm>1.34',
    '41.9GeV>dmet>-17.9GeV',
    'dphi_jj_central<2.58',
    'dphi_met_jetterm<0.73'
]
