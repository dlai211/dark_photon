...
Vars = [
    'balance', 'BDTScore', 'dmet', 'dphi_jj', 'dphi_met_central_jet', 'dphi_met_phterm',
    'dphi_met_jetterm', 'dphi_phterm_jetterm', 'dphi_ph_centraljet1',
    'ph_pt', 'ph_eta', 'ph_phi', 'jet_central_eta', 'jet_central_pt2',
    'jetterm', 'metsig', 'metsigres', 'met', 'met_noJVT', 'failJVT_jet_pt1', 'softerm', 'n_jet_central'
]

Vars2 = [
    'balance', 'VertexBDTScore', 'dmet', 'dphi_jj', 'dphi_met_central_jet', 'dphi_met_phterm',
    'dphi_phterm_jetterm', 'ph_phi', 'jet_central_eta', 'jet_central_pt2',
    'jetterm', 'metsig', 'metsigres', 'met_noJVT', 'softerm', 'n_jet_central', 'weights', 'label', 'process'
]
