...
def getVarDict():
    ...
    dict['n_ph']=                   {'var':'n_ph','bins':[7,0,7], 'title': 'N_{ph}'}
    dict['n_ph_baseline']=          {'var':'n_ph_baseline','bins':[7,0,7], 'title': 'N_{ph_baseline}'}
    dict['n_el_baseline']=          {'var':'n_el_baseline','bins':[7,0,7], 'title': 'N_{el_baseline}'}
    dict['n_mu_baseline']=          {'var':'n_mu_baseline','bins':[7,0,7], 'title': 'N_{mu_baseline}'}
    dict['n_tau_baseline']=         {'var':'n_tau_baseline','bins':[7,0,7], 'title': 'N_{tau_baseline}'}
...
def getSelDict():
    ...
    # my cut
    dict['trigger'] = {'str': ('trigger_HLT_g50_tight_xe40_cell_xe70_pfopufit_80mTAC_L1eEM26M')}
    dict['SR'] = {
        'str': (
            'n_ph == 1 && n_ph_baseline == 1 && n_tau_baseline == 0 && n_mu_baseline == 0 && n_el_baseline == 0 && '
            'trigger_HLT_g50_tight_xe40_cell_xe70_pfopufit_80mTAC_L1eEM26M && '
            'met_tst_et > 100000 && '
            'ph_pt[0] > 50000 && ' 
            'acos(cos(met_tst_phi-met_phterm_phi)) >= 1.25 && ' # dphi_met_phterm
            'met_tst_sig > 6 && ' # metsig
            'abs(ph_eta[0]) < 1.75 && ' # ph_eta
            '(met_tst_noJVT_et-met_tst_et) > -10000 && ' # dmet
    ...
    dict['dphi_met_jettermcut'] = {
        'str': (
            'met_tst_et > 100000 && '
            'trigger_HLT_g50_tight_xe40_cell_xe70_pfopufit_80mTAC_L1eEM26M && '
            'ph_pt[0] > 50000 && '
            '((met_jetterm_et!=0)*Alt$(acos(cos(met_tst_phi-met_jetterm_phi)),0)+(met_jetterm_et==0)*0) < 1.5'
    )}
    ...
    dict['balancecut'] = {
        'str': (
            ...
            'trigger_HLT_g50_tight_xe40_cell_xe70_pfopufit_80mTAC_L1eEM26M && '
            'ph_pt[0] > 50000 && '
            '(met_tst_et+ph_pt[0])/Sum$(jet_central_pt) <= 12'
    )}
